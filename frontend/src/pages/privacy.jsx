  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800 antialiased flex flex-col">
      <Helmet>
        ...
        <meta
          name="description"
          content="Privacy Policy for VR & Sons Bricks regarding data collection, usage, and security measures."
        />
      </Helmet>
            ...
            <article className="lg:col-span-9 space-y-8">
              ...
              >
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border border-stone-200">
                  <p className="text-stone-700 leading-relaxed mb-4 border-l-4 border-red-600 pl-4">
                    ...
                    , we collect information only when necessary to serve your
                    construction needs. This typically occurs when you
                    voluntarily submit an inquiry form or contact our support
                    team.
                  </p>
                    ...
                    {[
                      {
                        ...
                        desc: "Name, Email Address, and Mobile Number",
                      },
                      {
                        title: "Project Details",
                        desc: "Delivery Location, Required Quantity, and Product Type",
                      },
                      {
                        title: "Technical Data",
                        desc: "IP Address (for spam prevention) and Browser Type",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
                    ...
                    <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
                      ...
                      <p className="text-sm text-stone-600">
                        ...
                        <span className="font-medium text-emerald-700">
                          not sell, trade, or rent
                        </span>{" "}
                        your personal information. Data is only shared with
                        trusted logistics partners for delivery purposes.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    <div className="flex-1 space-y-4">
                      <p className="text-stone-600">
                        Our website uses standard "cookies" to enhance your user
                        experience. These are small files placed on your hard
                        drive for record-keeping purposes.
                      </p>
                      <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                        <p className="text-sm text-amber-800 flex items-start gap-2">
                          <AlertCircle className="w-4 h-4 mt-0.5 flex-shrink-0" />
                          <span>
                            You may choose to set your web browser to refuse
                            cookies. If you do so, note that some parts of the
                            Site may not function properly, particularly the
                            Inquiry Forms.
                          </span>
                        </p>
                      </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="space-y-3">
                      <p className="text-stone-700">
                        ...
                        processing practices to protect against unauthorized
                        access or destruction of your personal information.
                      </p>
                      <div className="bg-white p-3 rounded-lg border border-green-200">
                        <p className="text-sm text-green-800 flex items-center gap-2">
                          <ShieldCheck className="w-4 h-4" />
                          Our inquiry database is hosted on secure cloud
                          infrastructure utilizing industry-standard 256-bit AES
              ...
              >
                ...
                <p className="text-stone-400 mb-6 text-sm">
                  Our privacy team is here to address any concerns about your
