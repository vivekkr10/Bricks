...
import { ArrowRight, Hammer, Palette, BrickWall, Ruler, Truck, ChevronRight, History, LayoutGrid, Menu, X } from 'lucide-react';
...
const BrickWallBg = ({ opacity = 0.06, color = '#8B4513' }) => (
  <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
    ...
    <rect width="100%" height="100%" fill={`url(#bwall-services-${color.replace('#', '')})`} opacity={opacity} />
  </svg>
);
  ...
  return (
    <div className="antialiased bg-white selection:bg-orange-200 selection:text-orange-900 relative">
      ...
      <div className="lg:hidden sticky top-[60px] z-30 bg-white border-b border-stone-200 shadow-sm">
        ...
        {mobileNavOpen && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="border-t border-stone-100 bg-white">
            {services.map(item => (
              <button
                key={item.id}
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row">
            ...
            <main className="flex-1 px-5 sm:px-8 lg:pl-14 xl:pl-16 py-12 md:py-16 min-w-0">
              <ServiceSection
                id="matching" title="Brick Matching" icon={BrickWall}
              ...
              />
              <ServiceSection
                id="blending" title="Blending & Weathering" icon={Palette}
              ...
              />
              <ServiceSection
                id="custom" title="Custom Brick Making" icon={Hammer}
              ...
              />
              <ServiceSection
                id="technical" title="Technical Consultation" icon={Ruler}
              ...
              />
              <ServiceSection
                id="logistics" title="Logistics & Support" icon={Truck}
