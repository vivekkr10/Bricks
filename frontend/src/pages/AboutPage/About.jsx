  ...
  return (
    <div>
      ...
      `}</style>
        ...
        <section
          ref={heroRef}
          className={`border-b border-stone-300 mt-7 md:mt-${-10} lg:mt-8 min-h-screen relative flex items-center overflow-hidden bg-gradient-to-br from-stone-50 via-orange-50/40 to-stone-100 pt-20`}
        >
          ...
          <div className="max-w-7xl mt-0 mx-auto w-full relative z-10 px-4 sm:px-6 lg:px-16">
            <div className="max-w-3xl">
              {/* Badge */}
              <div
                className={`inline-flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-full px-4 py-2 mb-5 section-reveal ${heroInView ? "visible" : ""}`}
              >
              ...
              <h1 className="font-serif leading-none mb-8">
                {[
                  {
                    text: "Where",
                    cls: "text-6xl lg:text-7xl font-light text-stone-800",
                    delay: "0.15s",
                  },
                  {
                    text: "Clay",
                    cls: "text-6xl lg:text-7xl font-bold italic text-orange-600",
                    delay: "0.28s",
                  },
                  {
                    text: "Becomes",
                  ...
                  {
                    text: "Legacy.",
                    cls: "text-6xl lg:text-7xl font-bold text-stone-900",
                    delay: "0.54s",
                  },
                ].map(({ text, cls, delay }) => (
                  <span key={text} className="hero-line block overflow-hidden">
                    <span
                      className={`hero-word ${cls} h-20`}
              ...
              >
                ...
                identity — firing exceptional clay bricks for a nation that
                builds with pride, from the kilns of Godhra to skylines across
                46 countries.
              </p>

              <div
                className={`mb-10 flex flex-col sm:flex-row flex-wrap
              gap-4 lg:gap-6 section-reveal d4
              ${heroInView ? "visible" : ""}`}
              >
                <button
                  className="w-full sm:w-auto cursor-pointer
               px-8 py-4 bg-orange-600 text-white
               font-bold text-xs tracking-widest uppercase
               rounded-xl shadow-xl shadow-orange-200
               glow-btn hover:bg-orange-700
               hover:-translate-y-1 transition-all duration-300"
                ...
                <button
                  className="w-full sm:w-auto cursor-pointer
               px-8 py-4 border-2 border-stone-300 text-stone-600
               font-bold text-xs tracking-widest uppercase
               rounded-xl hover:border-orange-400 hover:text-orange-600
               hover:-translate-y-1 transition-all duration-300"
                >
                  Browse Products
                </button>
        ...
        {/* stats */}
        <section ref={statsRef} className="py-14 lg:py-15 px-8 bg-stone-50 ">
        ...
        <section
          ref={storyRef}
          className="border-t border-b border-stone-300 py-14 lg:py-15 px-8 bg-white relative overflow-hidden"
        >
          {/* Right half warm bg */}
          <BrickWall opacity={0.07} color="#8B4513" />
        ...
        <section
          ref={innovRef}
          className="py-14 lg:py-15 px-8 bg-stone-50 relative overflow-hidden"
         >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-stone-400 leading-relaxed font-light mb-8">
                    Fully automated firing at 1050°C ensures every brick
                    achieves identical compression strength, dimensional
                    accuracy, and rich tonal consistency — batch after batch.
                  </p>
        ...
        {/* Product Tabbb */}
        <section ref={productRef} className="py-14 lg:py-16 px-8 bg-white">
        ...
        {/* International */}
        <section className="py-14 lg:py-15 px-8 bg-stone-900 relative overflow-hidden">
          {/* Brick pattern bg */}
        ...
        {/* Team */}
        <section ref={teamRef} className="py-14 lg:py-15 px-8 bg-white">
        ...
        <section
          ref={storeRef}
          className="border-t border-stone-300 py-14 lg:py-15 px-8 bg-orange-50 relative overflow-hidden"
        >
          <BrickWall opacity={0.05} color="#8B4513" />
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10">
