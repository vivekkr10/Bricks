    ...
    <>
      ...
      `}</style>
        ...
        <div className={`${pageContainerClass} pt-12 pb-0`}>
          <button
            onClick={() => navigate("/products")}
            className="flex cursor-pointer items-center gap-2 text-red-600 hover:text-red-800 font-semibold transition-all group"
          >
            <svg
              ...
              <div className="sticky top-32">
                ...
                <div className="relative rounded-2xl overflow-hidden bg-white shadow-2xl shadow-red-200/50 mb-6 group brick-hover">
                  ...
                  <div className="absolute top-6 left-6 ">
                    <span className="px-2 py-1  bg-red-700 text-white font-semibold text-xs tracking-widest rounded-full shadow-lg">
                      {product.productType}
                    </span>
                  </div>
                  ...
                  <div className="absolute top-6 right-6">
                    <div className="px-2 py-1 bg-yellow-500 text-white font-semibold text-xs tracking-widest rounded-full shadow-lg flex items-center gap-2">
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
                        viewBox="0 0 20 20"
