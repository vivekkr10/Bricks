...
const InquiryPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.productName)
      return alert("Please specify the product you are interested in.");

    setLoading(true);
    try {
      const BACKEND_URL = "/api/inquiry/";
        ...
        <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 bg-white/40 backdrop-blur-3xl rounded-[3rem] border border-white/60 shadow-2xl overflow-hidden">
          ...
          <div className="lg:col-span-4 bg-stone-900/95 p-12 text-white flex items-center justify-center relative">
            <div className="absolute inset-0 opacity-20 grayscale pointer-events-none">
              <img
                src="https://i.pinimg.com/736x/21/38/37/213837c52c777a9912bccb45ee0384af.jpg"
            ...
            <div className="relative z-10 w-full text-center flex flex-col items-center">
              ...
              >
                <h3 className="text-4xl font-serif mb-10 italic text-red-500">
                ...
                <div className="space-y-12 flex flex-col items-center">
                  ...
                  <div className="max-w-[240px]">
                    ...
                    <p className="text-stone-300 text-sm font-light leading-relaxed">
                      High compressive strength standards.
                    </p>
                  </div>
                  <div className="max-w-[240px]">
                    <CheckCircle2 className="w-5 h-5 text-red-500 mx-auto mb-3" />
                ...
                <div className="mt-16 pt-8 border-t border-white/10 w-full">
                  ...
                  <p className="text-xl font-sans mt-2 text-white/90">
                    +91 98254 74047
                  </p>
                </div>
              </motion.div>
          ...
          <div className="lg:col-span-8 p-10 md:p-16 bg-white/50 relative">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="absolute top-8 right-10 flex items-center gap-2 text-stone-400 hover:text-red-600 transition-colors font-bold text-[12px] uppercase tracking-[0.3em] group z-30"
            >
            ...
            >
              <div className="md:col-span-2">
                <label className="text-[12px] font-bold uppercase tracking-[0.2em] text-stone-400 mb-2 block">
                  Full Name
                </label>
                <input
                  name="fullName"
                  ...
                  type="text"
                  className="w-full bg-transparent border-b border-stone-200 py-3 outline-none focus:border-red-600 transition-all text-stone-900 font-sans"
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  type="text"
                  className="w-full bg-transparent border-b border-stone-200 py-3 outline-none focus:border-red-600 transition-all text-stone-900"
                  placeholder="Site Address or Pincode"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="3"
                  className="w-full bg-transparent border-b border-stone-200 py-3 outline-none focus:border-red-600 transition-all text-stone-900 placeholder:text-stone-300 resize-none"
              ...
              <div className="md:col-span-2 pt-6">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-red-700 cursor-pointer text-white font-bold py-6 rounded-2xl hover:bg-red-800 transition-all duration-300 hover:translate-y-1 hover:shadow-xl active:scale-[0.98] uppercase tracking-[0.4em] text-[12px]"
                >
